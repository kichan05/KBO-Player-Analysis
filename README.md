...
- 스크리 플롯
    ...
    ![image.png](assets/pwa_스크리플롯.png)
...
- 주성분과 변수간 상관계수 히트맵
    ...
    ![image.png](assets/pwa_주성분상관관계_히트맵.png)

- 주성분 해석

| 주성분    | 변수와 관계                                                                                | 해석                                |
|--------|---------------------------------------------------------------------------------------|-----------------------------------|
| 0번 주성분 | 타점과 상관 계수 0.93, 안타와 상관계수 0.92, 이외에도 2루타, 득점, 장타율, 볼넷, 홈런, 타율, 출루율과 0.7이상의 상관계수를 가집니다. | 타격 능력에 대한 주성분으로 해석됩니다.            |
| 1번 주성분 | 도루와 상관계수 0.81, 3루타와 상관계수 0.71, 홈런과 상관계수 -0.47, 장타율과 상관계수 -0.33을 가집니다.                 | 장타력이 낮고, 발이 빠른 타자에 대한 주성분으로 해석됩니다. |
| 2번 주성분 | 삼진과 상관계수 0.68, 실책과 상관계수 0.52를 가집니다.                                                   | 경기 패배에 영향을 주는, 부정적인 주성분으로 해석됩니다.  |
| 3번 주성분 | 사구와 상관계수 0.7, 병살타와 상관계수 0.44를 가집니다.                                                   | 정확이 어떤 주성분인지 해석하기 어렵습니다.          |
