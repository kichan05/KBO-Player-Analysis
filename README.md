...
- 주성분과 변수간 상관계수 히트맵
    ...
    ![image.png](asstes/image%201.png)
...
- 주성분과 군집화 결과를 2차원 평면에 산점도로 표시
    ...
    ![image.png](asstes/image%202.png)
...
- 스크리플롯
    ...
    ![image.png](asstes/image%203.png)
    
    주성분 분석과 마찬가지로 요인의 개수가 4개 이후로 감소하는 기울기가 크게 변하기 때문에 요인의 개수는 4개를 사용하였습니다.
    
- 적재값 히트맵 구하기
    
    ![image.png](asstes/image%204.png)
    
- 요인 해석
    
    0번 요인과 타율, 출루율, 득점권타율, 안타와 상관계수가 0.6이상으로 높은 상관관계를 보이고 있다.
    0번 요인은 타격 능력을 의미하는 요인이라고 생각됩니다.
    
    1번 요인은 홈런, 장타율, 타점, 삼진 변수와 상관계수가 0.6이상
    1번 요인은 장타력을 의미하는 요인이라고 생각됩니다.
    
    이때 삼진 개수와 1번 요인의 상관 계수가 높기때문에 장타력이라고 해석해야 하는지는
    조금 더 생각해봐야 할것 같습니다.
    
    2번 요인 도루, 3루타와 상관계수가 0.7이상, 득점과의 상관계수는 0.59,
    2번 요인은 주루 능력을 의미하는 요인이라고 생각됩니다.
    
    3번 요인은 병살타, 볼넷 변수와 상관관계가 높으나 뚜렷한 특징으로 정의하기가 어렵습니다.
    
- 군집화 및 2차원 산점도로 표시
    
    ![image.png](asstes/image%205.png)