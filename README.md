...
- 요인 해석
    ...
    - 0번 요인
    타율, 출루율, 득점권타율, 안타와 상관계수가 0.6이상으로 높은 상관관계를 보이고 있습니다.
    0번 요인은 타격 능력을 의미하는 요인이라고 생각됩니다.
    
    - 1번 요인
    홈런, 장타율, 타점, 삼진 변수와 상관계수가 0.6이상입니다.
    ...
    - 2번 요인
    도루, 3루타와 상관계수가 0.7이상, 득점과의 상관계수는 0.59입니다.
    2번 요인은 주루 능력을 의미하는 요인이라고 생각됩니다.
    
    - 3번 요인
    병살타, 볼넷 변수와 상관관계가 높으나 뚜렷한 특징으로 정의하기가 어렵습니다.
